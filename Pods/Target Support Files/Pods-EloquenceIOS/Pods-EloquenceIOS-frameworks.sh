...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-EloquenceIOS/CocoaLumberjack.framework"
  install_framework "Pods-EloquenceIOS/KeychainSwift.framework"
  install_framework "Pods-EloquenceIOS/KissXML.framework"
  install_framework "Pods-EloquenceIOS/SwiftyUserDefaults.framework"
  install_framework "Pods-EloquenceIOS/XMPPFramework.framework"
  install_framework "Pods-EloquenceIOS/JSQMessagesViewController.framework"
  install_framework "Pods-EloquenceIOS/JSQSystemSoundPlayer.framework"
  install_framework "Pods-EloquenceIOS/ODRefreshControl.framework"
  install_framework "Pods-EloquenceIOS/SwiftySettings.framework"
