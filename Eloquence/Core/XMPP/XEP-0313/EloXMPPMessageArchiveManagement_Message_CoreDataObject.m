...
@property(nonatomic,strong) NSString * primitiveMessageId;
...
@dynamic messageId, primitiveMessageId;
...
- (void)setMessage:(XMPPMessage *)message
{
    ...
    self.primitiveMessageId = [message messageId];
